/*==============================================================================
SILVER LAYER – MASTER LOAD SCRIPT (Stored Procedure)
------------------------------------------------------------------------------
Purpose:
...
BEGIN
	...
	BEGIN TRY 
		...
		PRINT '>> Truncate complete: silver.crm_prd_info';
		...
		PRINT '>> Truncate complete: silver.crm_sales_details';
		...
		PRINT '>> Truncate complete: silver.erp_cust_az12';
		...
		PRINT '>> Truncate complete: silver.erp_px_cat_g1v2';
